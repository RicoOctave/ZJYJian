...
<h2 style="color:#FFD700 !important;margin:0;font-weight:900;font-size:1.9rem;letter-spacing:0.8px;text-shadow:0px 3px 3px #000000, 0px 5px 10px rgba(0,0,0,0.98);-webkit-text-stroke:0.8px rgba(0,0,0,0.75);">✍️ 真迹云鉴 — AI伪造电子签名轻量化快筛系统</h2>
