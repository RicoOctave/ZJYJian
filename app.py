...
<h2 style="color:#FFFFFF !important;margin:0;font-weight:900;font-size:1.9rem;letter-spacing:0.8px;text-shadow:0px 2px 2px #000000, 0px 4px 8px rgba(0,0,0,0.95);-webkit-text-stroke:0.6px rgba(0,0,0,0.6);">✍️ 真迹云鉴 — AI伪造电子签名轻量化快筛系统</h2>
